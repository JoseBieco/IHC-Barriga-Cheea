      ...
      >
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="mb-12">
            ...
            >
              <Input
                ...
                className="rounded-r-none border-gray-600 bg-[#FEFEFF] text-gray-800 cursor-text"
                aria-label="Digite seu e-mail para receber nossa newsletter"
                aria-required="true"
              />
              <Button
                className="bg-[#E65100] hover:bg-[#F57C00] rounded-l-none px-6 text-[#EBEBEB] cursor-pointer transition-colors focus:ring-2 focus:ring-[#F57C00]"
                type="submit"
          ...
          <div className="flex flex-wrap justify-between items-center border-t border-gray-700 pt-8">
            ...
            <nav
              className="flex flex-wrap gap-6 mb-4 lg:mb-0"
